...
var stringday = "Welcome to Assignment # 7 developed by Syed Muhammad Rafay Hassni";
var stringkasize = stringday.length;
console.log("The size of the string is", stringkasize);
alert(" Write a ts program to copy one string to another string.");
var stringlumber1 = "Han vai ki hal chal ay";
var stringlumber2 = "";
...
var stringnumb1 = "This is Syed Muhammad";
var stringnumb2 = " Rafay Hassni";
var stringfinale = stringnumb1 + stringnumb2;
...
var stringpehli = "Han bhai yeh hay pehli cheez";
var stringdosri = stringpehli.localeCompare("Han bhai yeh hay pehli cheez");
if (stringdosri == 0) {
...
var stringdayyar = "this is syed muhammad rafay";
var waddistring = stringdayyar.toUpperCase();
console.log("Your string in upper case is = ", waddistring);
alert("Write a ts program to convert uppercase string to lowercase.");
var waddistring = "I AM SYED MUHAMMAD RAFAY HASSNI PROUD PAKISTANI";
var chotistring = waddistring.toLocaleLowerCase();
...
function togglekarein(mixstring) {
    for (var index = 0; index < mixstring.length; index++) {
        var faltu = "";
        var alfaz = mixstring.charCodeAt(index);
        if (alfaz >= 60 && alfaz <= 90) {
            var choticheez = String.fromCharCode(alfaz).toLowerCase();
            faltu = choticheez;
            var result = result + faltu;
        }
        else if (alfaz >= 97 && alfaz <= 122) {
            var bricheez = String.fromCharCode(alfaz).toUpperCase();
            faltu = bricheez;
            result = result + faltu;
        }
...
var mixstring = "Han";
var stringfinale = togglekarein(mixstring);
...
var aikstringdun = "Hey this is syed muhammad rafay";
var vowel = 0;
var consonants = 0;
for (var index = 0; index < aikstringdun.length; index++) {
...
var number1 = 39;
var number2 = 67;
var result = number2 > number1 ? " = number 2 is greater than number 1" : "number 1 is greater";
...
var numb2 = 47;
var numb3 = 27;
var finalcheez = numb1 > numb2 && numb1 > numb3 ? " = number 1 is greater than number 2 and number 3" : numb2 > numb1 && numb2 > numb3 ? " = number 2 is greater than 1 and 3" : " = number3 is greater than 1 and 2";
...
var aikhinumber = 79;
var ajajadudikhaon = aikhinumber % 2 == 0 ? " = Your number is even" : " = Your number is odd";
...
var year = 2022;
var leapyeardikhaon = year % 4 == 0 ? " = your year is  a leap year" : " = your year is not a leap year";
...
var chracterbataapna = "@Chuh2dary1";
var alphabetbtaon = chracterbataapna >= 'a' && chracterbataapna <= 'z' || chracterbataapna >= 'A' && chracterbataapna <= 'Z' ? "Your inpted character is alphabet" : "Your inputed charcter is not alphabet";
console.log(chracterbataapna, alphabetbtaon);
alert("Write a ts program to print day of week name using switch case.");
var weeknamedas = "Write the number 1-7 to print that specific day";
var weeknameupdate = Number(weeknamedas);
